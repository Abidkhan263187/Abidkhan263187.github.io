...
import xtrapp from './images/xtrapp.PNG'
  ...
  return (
    <Box id="projects" >
      ...
      <Box className='project_main'>
        <ProjectCard tech="  MaterialUI | Next.js | Passport.js | Node.js | React Libraries " github="#" link="https://xtrapp.co/" avatar={xtrapp} name="Xtrapp" desc="At Xtrapp, we aim to define personal branding as the most powerful asset for monetization and growth." />
